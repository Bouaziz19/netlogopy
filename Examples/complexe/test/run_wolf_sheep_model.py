...
model_path = os.path.join(os.path.dirname(__file__), "Wolf Sheep Predation.nlogo")
output_file_path = os.path.join(os.path.dirname(__file__), "output_wolf_sheep.txt")
